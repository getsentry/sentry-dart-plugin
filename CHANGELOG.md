...
- Bump CLI from v2.41.1 to v2.50.0 ([#327](https://github.com/getsentry/sentry-dart-plugin/pull/327))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2500)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.41.1...2.50.0)
