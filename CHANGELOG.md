...
- Bump CLI from v2.27.0 to v2.33.0 ([#251](https://github.com/getsentry/sentry-dart-plugin/pull/251))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2330)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.27.0...2.33.0)
