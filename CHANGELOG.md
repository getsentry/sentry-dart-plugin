...
- Bump CLI from v2.27.0 to v2.37.0 ([#269](https://github.com/getsentry/sentry-dart-plugin/pull/269))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2370)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.27.0...2.37.0)
