...
- Bump CLI from v2.27.0 to v2.35.0 ([#259](https://github.com/getsentry/sentry-dart-plugin/pull/259))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2350)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.27.0...2.35.0)
