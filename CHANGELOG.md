...
- Bump CLI from v2.27.0 to v2.38.0 ([#271](https://github.com/getsentry/sentry-dart-plugin/pull/271))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2380)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.27.0...2.38.0)
