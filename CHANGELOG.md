...
- Bump CLI from v2.27.0 to v2.36.2 ([#263](https://github.com/getsentry/sentry-dart-plugin/pull/263))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2362)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.27.0...2.36.2)
