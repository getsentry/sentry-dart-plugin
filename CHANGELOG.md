...
- Bump CLI from v2.27.0 to v2.32.2 ([#248](https://github.com/getsentry/sentry-dart-plugin/pull/248))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2322)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.27.0...2.32.2)
