      ...
      group('url: $url', () {
        ...
        test('works with all configuration files', () async {
          ...
          expect(commandLog, [
            ...
            '$cli $args sourcemaps upload --release $release $buildDir/web --ext js --ext map --strip-prefix ../../../lib --strip-prefix ../../Documents --strip-prefix ../../../../ --strip-prefix ../../ --strip-prefix ../ ./lib --ext dart $orgAndProject',
        ...
        group('release', () {
          test('default from name and version', () async {
            ...
            expect(commandLog, [
              ...
              '$cli $args sourcemaps upload --release $release $buildDir/web --ext js --ext map --strip-prefix ../../../lib --strip-prefix ../../Documents --strip-prefix ../../../../ --strip-prefix ../../ --strip-prefix ../ $orgAndProject',
          ...
          test('release from config overrides default', () async {
            ...
            expect(commandLog, [
              ...
              '$cli sourcemaps inject build/web/file.js $orgAndProject',
              '$cli $args sourcemaps upload --release $configRelease $buildDir/web --ext js --ext map --strip-prefix ../../../lib --strip-prefix ../../Documents --strip-prefix ../../../../ --strip-prefix ../../ --strip-prefix ../ $orgAndProject',
        ...
        group('dist', () {
          test('read from pubspec version', () async {
            ...
            expect(commandLog, [
              '$cli $args releases $orgAndProject new $release',
              '$cli sourcemaps inject build/web/file.js $orgAndProject',
              '$cli $args sourcemaps upload --release $release --dist $build $buildDir/web --ext js --ext map --strip-prefix ../../../lib --strip-prefix ../../Documents --strip-prefix ../../../../ --strip-prefix ../../ --strip-prefix ../ $orgAndProject',
              '$cli $args releases $orgAndProject set-commits $release --auto',
              '$cli $args releases $orgAndProject finalize $release'
            ]);
          });
          ...
          test('used from config and appended to release', () async {
            ...
            expect(commandLog, [
              '$cli $args releases $orgAndProject new $release',
              '$cli sourcemaps inject build/web/file.js $orgAndProject',
              '$cli $args sourcemaps upload --release $release --dist $configDist $buildDir/web --ext js --ext map --strip-prefix ../../../lib --strip-prefix ../../Documents --strip-prefix ../../../../ --strip-prefix ../../ --strip-prefix ../ $orgAndProject',
              '$cli $args releases $orgAndProject set-commits $release --auto',
              '$cli $args releases $orgAndProject finalize $release'
            ]);
          });
          ...
          test('used from config but not appended to config release', () async {
            ...
            expect(commandLog, [
              '$cli $args releases $orgAndProject new $configRelease',
              '$cli sourcemaps inject build/web/file.js $orgAndProject',
              '$cli $args sourcemaps upload --release $configRelease --dist $configDist $buildDir/web --ext js --ext map --strip-prefix ../../../lib --strip-prefix ../../Documents --strip-prefix ../../../../ --strip-prefix ../../ --strip-prefix ../ $orgAndProject',
              '$cli $args releases $orgAndProject set-commits $configRelease --auto',
              '$cli $args releases $orgAndProject finalize $configRelease'
            ]);
          });
          ...
          test(
            ...
            expect(commandLog, [
              '$cli $args releases $orgAndProject new $configRelease',
              '$cli sourcemaps inject build/web/file.js $orgAndProject',
              '$cli $args sourcemaps upload --release $configRelease --dist $configDist --url-prefix ~/app/ $buildDir/web --ext js --ext map --strip-prefix ../../../lib --strip-prefix ../../Documents --strip-prefix ../../../../ --strip-prefix ../../ --strip-prefix ../ $orgAndProject',
              '$cli $args releases $orgAndProject set-commits $configRelease --auto',
              '$cli $args releases $orgAndProject finalize $configRelease'
            ]);
          });
