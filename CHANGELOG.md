...
- Bump CLI from v2.27.0 to v2.30.1 ([#211](https://github.com/getsentry/sentry-dart-plugin/pull/211))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2301)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.27.0...2.30.1)
