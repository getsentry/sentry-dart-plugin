...
- Bump CLI from v2.27.0 to v2.36.3 ([#264](https://github.com/getsentry/sentry-dart-plugin/pull/264))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2363)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.27.0...2.36.3)
